  ...
  if (!product) {
    return (
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Button component={Link} href="/policies" sx={{ mt: 2 }}>
          Back to Policies
        </Button>
      </Container>
    );
        ...
        <Container maxWidth="xl">
          <Stack spacing={3}>
            ...
            <Breadcrumbs aria-label="breadcrumb">
              <MuiLink component={Link} href="/policies" color="inherit" sx={{ textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
                Policies
              </MuiLink>
                ...
                <Card
                  ...
                  sx={{
                    ...
                    background: pkg.popular
                      ? 'linear-gradient(180deg, rgba(25, 118, 210, 0.08) 0%, rgba(255, 255, 255, 1) 100%)'
                      : 'white',
                    boxShadow: pkg.popular ? 4 : 1,
                    '&:hover': {
                      transform: 'translateY(-6px) scale(1.02)',
                      boxShadow: pkg.popular ? 12 : 6,
                      borderColor: 'primary.main',
                      zIndex: 2,
                    },
                  }}
                >
                  {/* Most Popular badge at the edge/corner of the box */}
                  {pkg.popular && (
                    <Chip
                      label="Most Popular"
                      color="primary"
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        ...
                        p: 2.5,
                        borderRadius: 2,
                        backgroundColor: pkg.popular ? 'primary.main' : 'rgba(25, 118, 210, 0.08)',
                        textAlign: 'center',
                      }}
                    >
                      <Typography
                        ...
                        fontWeight={900}
                        sx={{
                          color: pkg.popular ? 'white' : 'primary.main',
                      ...
                      <Typography
                        variant="caption"
                        sx={{
                          color: pkg.popular ? 'rgba(255, 255, 255, 0.9)' : 'text.secondary',
                          fontWeight: 500,
                          mt: 0.5,
                          fontSize: '0.75rem',
                        }}
                    ...
                    <Typography
                      ...
                      fontWeight={700}
                      gutterBottom
                      sx={{ mb: 1.5, color: 'text.primary', fontSize: '0.875rem' }}
                    >
                      Benefits
                    </Typography>
                    <Stack spacing={1} sx={{ mb: 2, flexGrow: 1 }}>
                      {pkg.benefits.map((benefit, idx) => (
                        <Stack key={idx} direction="row" spacing={1} alignItems="flex-start">
                          <CheckIcon sx={{ color: 'success.main', fontSize: 16, mt: 0.25, flexShrink: 0 }} />
                          <Typography variant="caption" sx={{ lineHeight: 1.5, fontSize: '0.75rem', color: 'text.secondary' }}>
                            {benefit}
                          </Typography>
                        </Stack>
                      ))}
                        ...
                        <Stack spacing={0.75} sx={{ mb: 2 }}>
                          {pkg.hospitals.map((hospital, idx) => (
                            <Stack key={idx} direction="row" spacing={1} alignItems="center">
                              <HospitalIcon sx={{ color: 'primary.main', fontSize: 14, flexShrink: 0 }} />
